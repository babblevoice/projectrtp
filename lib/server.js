  ...
  async mix( other ) {
    ...
    else
    {
      ...
      if( !bridge_found )
      {
        ...
        bridge1 = await s.openchannel( { "selected_node": this.remotenode.status.instance }, this.cb )
        bridge2 = await s.openchannel( { "selected_node": other.remotenode.status.instance }, other.cb )
