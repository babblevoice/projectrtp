...
class channel {
  ...
  */
  async mix( other ) {
    if( other.remotenode.instance === this.remotenode.instance )
    {
    ...
    else
    {
      ...
      for ( let nodebridge in other.nodebridges )
      {
        ...
        if ( nodebridge.other.node === this.remotenode.instance )
        {
          this._write( {
            "channel": "mix",
            "other": {
      ...
      var bridge1 = await s.openchannel( { "nodeinstance": this.remotenode.instance }, this.cb )
      var bridge2 = await s.openchannel( { "nodeinstance": other.remotenode.instance }, other.cb )
...
_addnodebridge( other, remote )
{
  ...
  if ( this.nodebridges.length !=0 && other.nodebridges.length != 0 )
  {
    if ( remote )
    {
      this.nodebridges.push({
        "main": {
          "node": this.remotenode.instance,
          "channels": this.mixes,
          "bridge": remote.bridge1
        },
        "other": {
          "node": other.remotenode.instance,
    ...
    {
      nodebridge.main.node = this.remotenode.instance
  ...
  */
  unmix(){
    ...
    {
      if ( nodebridge.other.node === this.remotenode.instance && nodebridge.main.node != this.remotenode.instance )
      {
