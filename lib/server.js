  ...
  async mix( other ) {
    ...
    else
    {
      ...
      if( !bridge_found )
      {
        ...
        bridge1.remote({ "address": bridge2.remoteadress, "port": bridge2.port, "codec": this.codec })
        bridge2.remote({ "address": bridge1.remoteadress, "port": bridge1.port, "codec": other.codec })
        let bridgechannel = {
          "channel1": bridge1,
          "channel2": bridge2,
