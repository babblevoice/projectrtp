  ...
  */
  async mix( other ) {
    if( other.remotenode.status.instance === this.remotenode.status.instance )
    {
      ...
      other.mixes = combinemixes( this.mixes, other.mixes )
    }
    else
    {
      ...
      for ( let bridge in other.bridges )
      {
        ...
        {
          bridge.mixes = combinemixes( this.mixes, bridge.mixes )
          this._write( {
            "channel": "mix",
            "other": {
              "id": bridge.id,
      ...
      bridge1.mixes = combinemixes( this.mixes, bridge1.mixes )
      bridge2.mixes = combinemixes( other.mixes, bridge2.mixes )
