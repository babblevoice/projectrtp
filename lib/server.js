...
class channel {
  ...
  */
  ...
  @property { ( number | boolean ) } soundsoupfile.loop - continue looping this soup until other instruction (or the number of loops)
  ...
  */
  ...
  @param { ( number | boolean ) } soundsoup.loop - continue looping this soup until other instruction (or the number of loops)
  ...
  _on( msg ) {
    if( "open" === msg.action ) {
      if( undefined !== this.openresolve ) {
        ...
        @property {string} remote.dtls.fingerprint
        @property {boolean} remote.dtls.enabled
        */
