...
describe( "rtpproxy multi node", function() {
  ...
  it( `2 node simple mix`, async function() {
    ...
    */
    ...
    expect( rtpreceveivedmessages[ 9 ].channel ).to.equal( "unmix" )
    expect( rtpreceveivedmessages[ 9 ].node ).to.equal( "rtp1" )
    expect( rtpreceveivedmessages[ 9 ] ).to.have.property( "channel" ).that.is.a( "string" ).to.equal( "unmix" )
    expect( rtpreceveivedmessages[ 9 ] ).to.have.property( "id" ).that.is.a( "string" )
    expect( rtpreceveivedmessages[ 9 ] ).to.have.property( "uuid" ).that.is.a( "string" )
    expect( rtpreceveivedmessages[ 10 ].channel ).to.equal( "close" )
    expect( rtpreceveivedmessages[ 10 ].node ).to.equal( "rtp1" )
    expect( rtpreceveivedmessages[ 11 ].channel ).to.equal( "close" )
    expect( rtpreceveivedmessages[ 11 ].node ).to.equal( "rtp1" )
