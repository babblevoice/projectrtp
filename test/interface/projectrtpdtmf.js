...
describe( "dtmf", function() {
  ...
  it( "mix 3 channels - pcmu <-> pcma and ilbc and send DTMF", async function() {
    ...
    sendpk( 26, 22*160, 21*20, channela.local.port, endpointa, 0 )
    sendpk( 27, 23*160, 22*20, channela.local.port, endpointa, 0 )
    sendpk( 28, 24*160, 23*20, channela.local.port, endpointa, 0 )
    sendpk( 29, 25*160, 24*20, channela.local.port, endpointa, 0 )

    senddtmf( 30, 25*160, 24*20, channela.local.port, endpointa, false, "5" )
    sendpk( 31, 26*160, 25*20, channela.local.port, endpointa, 0 )
    sendpk( 32, 27*160, 26*20, channela.local.port, endpointa, 0 )
    senddtmf( 33, (27*160), (24*20)+50, channela.local.port, endpointa, false, "5" )
    sendpk( 34, 28*160, 27*20, channela.local.port, endpointa, 0 )
    sendpk( 35, 29*160, 28*20, channela.local.port, endpointa, 0 )
    senddtmf( 36, (29*160), (24*20)+100, channela.local.port, endpointa, true, "5" )
    sendpk( 37, 30*160, 29*20, channela.local.port, endpointa, 0 )
    sendpk( 38, 31*160, 30*20, channela.local.port, endpointa, 0 )
    senddtmf( 33, (31*160), (24*20)+150, channela.local.port, endpointa, true, "5" )
    sendpk( 39, 32*160, 31*20, channela.local.port, endpointa, 0 )
    sendpk( 40, 33*160, 32*20, channela.local.port, endpointa, 0 )
    sendpk( 41, 34*160, 33*20, channela.local.port, endpointa, 0 )
    sendpk( 42, 35*160, 34*20, channela.local.port, endpointa, 0 )
    sendpk( 43, 36*160, 35*20, channela.local.port, endpointa, 0 )
    sendpk( 44, 37*160, 36*20, channela.local.port, endpointa, 0 )
    sendpk( 45, 38*160, 37*20, channela.local.port, endpointa, 0 )
    sendpk( 46, 39*160, 38*20, channela.local.port, endpointa, 0 )
    sendpk( 47, 40*160, 39*20, channela.local.port, endpointa, 0 )
    sendpk( 48, 41*160, 40*20, channela.local.port, endpointa, 0 )
    sendpk( 49, 42*160, 41*20, channela.local.port, endpointa, 0 )
    sendpk( 50, 43*160, 42*20, channela.local.port, endpointa, 0 )
    sendpk( 51, 44*160, 43*20, channela.local.port, endpointa, 0 )
    sendpk( 52, 45*160, 44*20, channela.local.port, endpointa, 0 )
    sendpk( 53, 46*160, 45*20, channela.local.port, endpointa, 0 )
    sendpk( 54, 47*160, 46*20, channela.local.port, endpointa, 0 )
    sendpk( 55, 48*160, 47*20, channela.local.port, endpointa, 0 )
    sendpk( 56, 49*160, 48*20, channela.local.port, endpointa, 0 )
    sendpk( 57, 50*160, 49*20, channela.local.port, endpointa, 0 )
    sendpk( 58, 52*160, 50*20, channela.local.port, endpointa, 0 )
